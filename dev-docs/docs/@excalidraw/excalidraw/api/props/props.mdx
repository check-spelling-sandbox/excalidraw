...
This prop indicates whether to shows the grid. When supplied, the value takes precedence over _initialData.appState.gridModeEnabled_, the grid will be fully controlled by the host app, and users won't be able to toggle it from within the app.
