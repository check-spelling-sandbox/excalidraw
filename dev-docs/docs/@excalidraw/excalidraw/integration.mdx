...
Here is a [source code](https://github.com/excalidraw/excalidraw/tree/master/examples/with-nextjs) for the example with app and pages router. You you can [try out the app](https://excalidraw-package-example-with-nextjs.vercel.app/).
...
You can [try it out](https://jsfiddle.net/vfn6dm14/3/).
